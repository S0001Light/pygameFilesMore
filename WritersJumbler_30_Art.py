...
pygame.display.set_caption("Writers Jumbler 30 Art - start with keyboard letter q, then either w, e, r, t, y, u, i, o,  p=erase, also, press S on the keyboard to Save")
